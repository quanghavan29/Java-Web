<%-- 
    Document   : order
    Created on : Dec 14, 2020, 9:57:15 AM
    Author     : ADMIN
--%>
                ...
                <div class="table-responsive cart_info">
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.listOrder}" var="o">
                                <tr>
                                    <td class="cart_product">
                                        <a href=""><img src="images/home/${o.product.image}" alt="" style="width: 40%;"/></a>
                                    </td>
                                    <td class="cart_description">
                            <h9><a href="">Old Skool Platform Sneakers - Black</a></h9>
                            ...
                            <td>
                                <p style="font-size: 18px; color: #0480be; font-weight: bold;">${o.status}</p>
                            </td>
                            </tr>
                        </c:forEach>
                        </tbody>
